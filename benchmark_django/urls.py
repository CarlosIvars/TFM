...
urlpatterns = [
    ...
    # Polling de estado usando resultado_id (clave simple)
    path('run/status/<int:resultado_id>/', run_status, name='run_status'),
    ...
    path('api/resultado/<int:resultado_id>/', api_resultado_detail, name='api_resultado_detail'),
